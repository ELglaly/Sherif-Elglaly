...
document.querySelectorAll('#filterCertificate .filter-btn').forEach(btn => {
    btn.addEventListener('click', function() {
        ...
        document.querySelectorAll('#filterCertificate .filter-btn').forEach(b => {
        ...
        const certificates = document.querySelectorAll('#certificateElement > div');
        ...
        // Function to animate visible items

function animateItems() {
    const visibleItems = document.querySelectorAll('#certificateContent .timeline[style="display: block;"]');
